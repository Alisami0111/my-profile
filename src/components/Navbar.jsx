    ...
    <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#f7dbd3] text-gray-900 z-10'>
      ...
      <ul
        className={
          !nav
            ? 'hidden'
            : 'absolute top-0 left-0 w-full h-screen bg-[#f7dbd3] text-[#DD5746] flex flex-col justify-center items-center'
        }
      >
      ...
      <div className='hidden lg:flex fixed flex-col top-[35%] left-0'>
        <ul>
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[0px] duration-300 bg-[#0A66C2] rounded-[0% 5% 0% 0%]'>
            <a
              className='flex justify-between items-center w-full text-gray-300 px-3'
              href='https://www.linkedin.com/in/ali-sami-301134247/'  target='_blank'
            >
          ...
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[0px] duration-300 bg-[#333333]'>
            <a
              className='flex justify-between items-center w-full text-gray-300 px-3'
              href='https://github.com/Alisami0111' target='_blank'
            >
